...
def order():
    ...
    instXAQueryCSPAT00600.SetFieldData("CSPAT00600InBlock1", "IsuNo", 0, '078020')
    instXAQueryCSPAT00600.SetFieldData("CSPAT00600InBlock1", "OrdQty", 0, '10')
    instXAQueryCSPAT00600.SetFieldData("CSPAT00600InBlock1", "OrdPrc", 0, '11200')
    ...
    print('주문번호: ', instXAQueryCSPAT00600.GetFieldData('CSPAT00600OutBlock2', 'OrdNo', 0))
