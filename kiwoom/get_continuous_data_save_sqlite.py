...
class Kiwoom(QAxWidget):
    ...
    def _receive_tr_data(self, screen_no, rqname, trcode, record_name,
                         next, unused1, unused2, unused3, unused4):
        if next == '2':
...
if __name__ == "__main__":
    ...
    con = sqlite3.connect("kiwoom_continuous_data.db")
