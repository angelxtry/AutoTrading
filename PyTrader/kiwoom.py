...
class Kiwoom(QAxWidget):
    ...
    def send_order(self, rqname, screen_no, acc_no, order_type,
        ...
        self.dynamicCall(("SendOrder(QString, QString, QString, int, QString,"
                          "int, int, QString, QString)"),
                         [rqname, screen_no, acc_no, order_type, code,
                          quantity, price, hoga, order_no])
    ...
    def _opw00001(self, rqname, trcode):
        d2_deposit = self._comm_get_data(trcode, "", rqname,
                                              0, "d+2추정예수금")
...
if __name__ == "__main__":
    ...
    kiwoom.set_input_value("계좌번호", "8100478211")
    kiwoom.set_input_value("비밀번호", "rudals12")
